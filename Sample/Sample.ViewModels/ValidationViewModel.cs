...
namespace Sample.ViewModels
{
    public class ValidationViewModel
    {
        public ValidationViewModel()
        {
            ...
            // Validation is view initialized not run in default. If want to validate on view
            // initialize, use ReactivePropertyMode.RaiseLatestValueOnSubscribe to ReactiveProperty
        ...
        public RxCommand NextCommand { get; }
