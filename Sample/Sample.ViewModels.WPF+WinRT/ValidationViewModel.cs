...
namespace Sample.ViewModels
{
    public class ValidationViewModel
    {
        public ValidationViewModel()
        {
            ...
            this.ValidationAttr = new ReactiveProperty<string>()
                .SetValidateAttribute(() => this.ValidationAttr);
            ...
            this.ValidationBoth = new ReactiveProperty<string>()
                .SetValidateAttribute(() => this.ValidationBoth)
            ...
            var errors = new[]
                {
                    ...
                    this.ValidationAttr.ObserveErrorChanged
                }
                .CombineLatest(x =>
                {
            ...
            this.ErrorInfo = errors.ToReactiveProperty();
        }
