...
namespace Reactive.Bindings
{
    ...
    public static class ReadOnlyReactiveCollection
    {
        ...
        /// <returns></returns>
        public static IObservable<CollectionChanged<T>> ToCollectionChanged<T>(this INotifyCollectionChanged self) => Observable.Create<CollectionChanged<T>>(ox =>
                                                                                                                                {
    ...
    public class CollectionChanged<T>
    {
        ...
        /// <returns></returns>
        public static CollectionChanged<T> Add(int index, T value) => new CollectionChanged<T>
        {
            Index = index,
            Value = value,
        ...
        /// <returns></returns>
        public static CollectionChanged<T> Move(int oldIndex, int newIndex, T value) => new CollectionChanged<T>
        {
            OldIndex = oldIndex,
            Index = newIndex,
            Value = value,
        ...
        /// <returns></returns>
        public static CollectionChanged<T> Remove(int index, T value) => new CollectionChanged<T>
        {
            Index = index,
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static CollectionChanged<T> Replace(int index, T value) => new CollectionChanged<T>
        {
            Index = index,
            Value = value,
    ...
    public class ReadOnlyReactiveCollection<T> : ReadOnlyObservableCollection<T>, IDisposable
    {
        ...
        public virtual void Dispose()
        {
            ...
            this.Token.Dispose();
            foreach (IDisposable d in this.OfType<IDisposable>().ToArray()) { InvokeDispose(d); }
        }
