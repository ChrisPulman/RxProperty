    ...
    public static class INotifyPropertyChangedExtensions
    {
            ...
            where TSubject : INotifyPropertyChanged
        {
            ...
            return Observable.Defer(() =>
            {
                ...
                IObservable<TProperty> q = subject.PropertyChangedAsObservable()
        ...
        {
            // no use
            Action<TSubject, TProperty> setter = AccessorCache<TSubject>.LookupSet(propertySelector, out var propertyName);
