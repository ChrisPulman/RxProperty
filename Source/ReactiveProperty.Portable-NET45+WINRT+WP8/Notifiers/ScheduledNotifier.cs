...
namespace Reactive.Bindings.Notifiers
{
    ...
    public class ScheduledNotifier<T> : IObservable<T>, IProgress<T>
    {
        ...
        /// </summary>
        public ScheduledNotifier() => this.scheduler = Scheduler.Immediate;
        /// <summary>
        ...
        /// </summary>
        public void Report(T value) => this.scheduler.Schedule(() => this.trigger.OnNext(value));

        /// <summary>
        /// Push value to subscribers on setuped scheduler.
        /// </summary>
        public IDisposable Report(T value, TimeSpan dueTime) => this.scheduler.Schedule(dueTime, () => this.trigger.OnNext(value));

        /// <summary>
        /// Push value to subscribers on setuped scheduler.
        /// </summary>
        public IDisposable Report(T value, DateTimeOffset dueTime) => this.scheduler.Schedule(dueTime, () => this.trigger.OnNext(value));
