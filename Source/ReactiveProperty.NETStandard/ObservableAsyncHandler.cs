...
namespace Reactive.Bindings
{
    ...
    public static class ObservableAsyncHandlerExtensions
    {
        ...
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static TaskAwaiter<T> GetAwaiter<T>(this RxCommand<T> source)
        {
            return WaitUntilValueChangedAsync<T>(source, CancellationToken.None).GetAwaiter();
        }
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns></returns>
        public static async Task<T> WaitUntilValueChangedAsync<T>(this RxCommand<T> source, CancellationToken cancellationToken = default(CancellationToken))
        {
            using (var handler = GetAsyncHandler<T>(source, cancellationToken)) {
                return await handler;
            }
